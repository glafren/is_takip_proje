namespace is_takip_proje
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.BtnAktifCagrilar.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItem1_ItemClick);
			// 
			// BtnPasifCagrilar
			// 
			...
			this.BtnPasifCagrilar.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.BtnPasifCagrilar_ItemClick);
			// 
			// ribbonPage1
			// 
